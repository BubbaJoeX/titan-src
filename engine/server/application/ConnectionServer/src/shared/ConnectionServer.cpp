...
ConnectionServer::ConnectionServer()
    ...
    // Extended player data can produce a multi-megabyte initial baseline burst. Keep the
    // reliable queue setting scoped to external clients; internal server connections retain
    // their shared-network limits. clientOverflowLimit provides the lower diagnostic cutoff.
    s_clientServiceSetup->reliableOverflowBytes = ConfigConnectionServer::getClientReliableOverflowBytes();
    LOG("Network", ("External client queue limits: clientOverflowLimit=%d, clientReliableOverflowBytes=%d",
        ConfigConnectionServer::getClientOverflowLimit(), s_clientServiceSetup->reliableOverflowBytes));
